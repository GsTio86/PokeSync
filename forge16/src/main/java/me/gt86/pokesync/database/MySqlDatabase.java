...
public class MySqlDatabase extends Database {
    ...
    private static final String DATA_POOL_NAME = "PokeSyncHikariPool";
    private final String flavor;
    private final String driverClass;
    private HikariDataSource dataSource;

    public MySqlDatabase(@NotNull PokeSync plugin) {
        super(plugin);
    ...
    @Override
    public void initialize() throws PokeSync.FailedToLoadException {
    ...
    public Optional<DataSnapshot.Packed> getDataSnapshot(@NotNull User user, @NotNull UUID versionUuid) {
        ...
        plugin.debug(String.format("No data found for user uuid: %s for ID %s", user.getUuid(), versionUuid));
        return Optional.empty();
    }
