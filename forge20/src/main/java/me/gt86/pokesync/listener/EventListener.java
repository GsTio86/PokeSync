...
public abstract class EventListener {
    ...
    protected EventListener(@NotNull PokeSync plugin) {
        this.plugin = plugin;
    ...
    /**
     * Represents priorities for events that PokeSync listens to
     */
    ...
    /**
     * Represents events that PokeSync listens to, with a configurable priority listener
     */
