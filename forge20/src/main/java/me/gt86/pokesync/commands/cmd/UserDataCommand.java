...
import me.gt86.pokesync.util.DataSnapshotList;
import me.gt86.pokesync.util.DataSnapshotOverview;
...
public class UserDataCommand extends Command implements TabProvider {
    ...
    public UserDataCommand(@NotNull PokeSync plugin) {
        super("pmuserdata", List.of("playerpmdata"), String.format(
    ...
    public void execute(@NotNull CommandUser executor, @NotNull String[] args) {
        ...
        switch (args[0].toLowerCase(Locale.ENGLISH)) {
            case "view" -> {
                if (args.length < 2) {
                    plugin.getLocales().getLocale("error_invalid_syntax",
                            "/pmuserdata view <username> [version_uuid]")
                        .ifPresent(executor::sendMessage);
                    return;
                }
            ...
            case "delete" -> {
                ...
                if (args.length < 3) {
                    plugin.getLocales().getLocale("error_invalid_syntax",
                            "/pmuserdata delete <username> <version_uuid>")
                        .ifPresent(executor::sendMessage);
                    return;
                }
                final String username = args[1];
            ...
            case "restore" -> {
                ...
                if (args.length < 3) {
                    plugin.getLocales().getLocale("error_invalid_syntax",
                            "/pmuserdata restore <username> <version_uuid>")
                        .ifPresent(executor::sendMessage);
                    return;
                }
                final String username = args[1];
            ...
            case "pin" -> {
                if (args.length < 3) {
                    plugin.getLocales().getLocale("error_invalid_syntax",
                            "/pmuserdata pin <username> <version_uuid>")
                        .ifPresent(executor::sendMessage);
                    return;
                }
            ...
            case "dump" -> {
                if (args.length < 3) {
                    plugin.getLocales().getLocale("error_invalid_syntax",
                            "/pmuserdata dump <username> <version_uuid>")
                        .ifPresent(executor::sendMessage);
                    return;
                }
