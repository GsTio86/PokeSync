...
public abstract class BukkitDataContainer implements DataContainer {
    ...
    public static class Lure implements DataContainer.Lure, Adaptable {
        ...
        public void apply(@NotNull DataOwner user) throws IllegalStateException {
            ...
            if (lureData.lure.isBlank()) {
                ...
                try {
                    ItemStack itemStack = ItemStack.of(TagParser.parseTag(lureData.lure));
    ...
    public static class Pokedex implements DataContainer.Pokedex, Adaptable {
        ...
        public void apply(@NotNull DataOwner user) throws IllegalStateException {
            ...
            PlayerPartyStorage storage = StorageProxy.getParty(player.getUniqueId());
            try {
                storage.playerPokedex.readFromNBT(Objects.requireNonNull(TagParser.parseTag(pokedexData.playerPokedex)));
            } catch (Exception e) {
    ...
    public static class Quest implements DataContainer.Quest, Adaptable {
        ...
        public void apply(@NotNull DataOwner user) throws IllegalStateException {
            ...
            PlayerPartyStorage storage = StorageProxy.getParty(player.getUniqueId());
            try {
                storage.getQuestData().readFromNBT(Objects.requireNonNull(TagParser.parseTag(questData.data)));
            } catch (Exception e) {
